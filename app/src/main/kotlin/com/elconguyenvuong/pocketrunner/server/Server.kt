...
val availableStats = listOf("PocketMine-MP", "Online", "Memory", "U", "D", "TPS", "Load")
...
class Server(val files: Files) {
    ...
    fun run() {
        ...
        val binary = File(files.php.toString())
        ...
        val tmpDir = File(files.dataDirectory.toString() + "/tmp")
        ...
        try {
        	Runtime.getRuntime().exec("/system/bin/chmod -R 777 " + binary.getAbsolutePath())
